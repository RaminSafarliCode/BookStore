...
namespace BookStore.Application.AppCode.Extenstions
{
    ...
    {
        const string saltKey = "final@@RaminBook!";
        public static string ToMd5(this string value)
        {
            byte[] buffer = Encoding.UTF8.GetBytes($"{saltKey}{value}BookStore.Application.AppCode.Extensions");
        ...
        {
            byte[] buffer = Encoding.UTF8.GetBytes($"{saltKey}{value}2BookStore.Application.AppCode.Extensions");
        ...
        {
            byte[] buffer = Encoding.UTF8.GetBytes($"{saltKey}{value}1BookStore.Application.AppCode.Extensions");
